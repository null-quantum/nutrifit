  ...
  return (
    <section className="py-24 lg:py-32 bg-[#0B1120] relative overflow-hidden">
      ...
      <Floating
        distance={30}
        duration={10}
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-emerald-500/10 blur-[120px] rounded-full pointer-events-none"
      />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto">
          <h2 className="text-emerald-400 font-bold tracking-wider uppercase text-sm mb-4">
            <TextReveal text="Pricing Plans" mode="block" delay={0.05} />
          </h2>
              ...
              <div className="relative h-full">
                ...
                {plan.isPopular && (
                  <Floating
                    distance={12}
                    duration={5}
                    className="absolute -inset-2 bg-gradient-to-r from-emerald-500/30 to-teal-400/30 blur-2xl rounded-3xl pointer-events-none"
                  />
                )}
                <MagneticCard
                  strength={6}
                  lift={8}
                  className={`relative h-full rounded-3xl p-8 lg:p-10 transition-shadow duration-300 ${
                    plan.isPopular
