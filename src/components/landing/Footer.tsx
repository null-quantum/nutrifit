  ...
  return (
    <footer className="relative bg-[#05070D] border-t border-white/5 pt-20 pb-10 overflow-hidden mt-auto">
      ...
      <ParallaxLayer speed={0.2} className="absolute inset-0 z-0">
        <div
          className="absolute inset-0 opacity-10 mix-blend-luminosity grayscale"
          style={{
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <StaggerContainer
          stagger={0.1}
          delayChildren={0.05}
          className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20 pb-12 border-b border-white/10"
        >
          {[
            ...
            <StaggerItem key={i} direction="up" distance={24}>
        ...
        <ScrollReveal direction="fade" distance={0} duration={0.8}>
        ...
        <ScrollReveal direction="fade" distance={0} duration={0.8} delay={0.2}>
